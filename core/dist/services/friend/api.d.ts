...
export declare function putPlantItems(friendGid: number, landIds: number[], RequestType: any, ReplyType: any, method: string, propagateErrors?: boolean): Promise<number>;
export declare function putPlantItemsDetailed(friendGid: number, landIds: number[], RequestType: any, ReplyType: any, method: string, propagateErrors?: boolean): Promise<{
    ok: number;
    failed: any[];
    limitReached?: boolean;
}>;
export declare function putInsects(friendGid: number, landIds: number[], propagateErrors?: boolean): Promise<number>;
export declare function putWeeds(friendGid: number, landIds: number[], propagateErrors?: boolean): Promise<number>;
export declare function putInsectsDetailed(friendGid: number, landIds: number[], propagateErrors?: boolean): Promise<{
    ok: number;
    failed: any[];
    limitReached?: boolean;
}>;
export declare function putWeedsDetailed(friendGid: number, landIds: number[], propagateErrors?: boolean): Promise<{
    ok: number;
    failed: any[];
    limitReached?: boolean;
}>;
