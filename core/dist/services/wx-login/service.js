...
function extractNickname(body) {
    ...
    if (!callbackData || typeof callbackData !== 'object')
        return undefined;
    let userInfo = callbackData.user_info;
...
function extractUserInfoNickname(data) {
...
async function fetchUserInfo(cookies, openid, accessToken) {
    const timestamp = String(Date.now());
    const nonce = String(node_crypto_1.default.randomInt(0, 10000));
    const requestId = String(node_crypto_1.default.randomInt(1000, 10000));
