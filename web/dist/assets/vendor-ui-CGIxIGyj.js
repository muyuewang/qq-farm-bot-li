import{L as bo,f as D,G as Tn,w as Ye,c as F,D as Or,C as kt,M as Pt,N as In,r as Br,h as Ie,O as _s,P as Es,Q as gr,R as At,S as Zi,I as le,K as Ke,T as sn,J as c,U as Qi,d as ye,n as mt,V as zu,W as As,X as qo,Y as Tu,s as Ru,v as Dt,m as Ha,Z as Yt,_ as Hs,$ as No,a0 as Ji,a1 as Mu,a2 as Ls,a3 as Ti}from"./vendor-akYgF5gd.js";function Fu(e){let t=0;for(let n=0;n<e.length;++n)e[n]==="&"&&++t;return t}const Ns=/\s*,(?![^(]*\))\s*/g,Ou=/\s+/g;function Bu(e,t){const n=[];return t.split(Ns).forEach(o=>{let r=Fu(o);if(r){if(r===1){e.forEach(l=>{n.push(o.replace("&",l))});return}}else{e.forEach(l=>{n.push((l&&l+" ")+o)});return}let i=[o];for(;r--;){const l=[];i.forEach(a=>{e.forEach(s=>{l.push(a.replace("&",s))})}),i=l}i.forEach(l=>n.push(l))}),n}function Iu(e,t){const n=[];return t.split(Ns).forEach(o=>{e.forEach(r=>{n.push((r&&r+" ")+o)})}),n}function Du(e){let t=[""];return e.forEach(n=>{n=n&&n.trim(),n&&(n.includes("&")?t=Bu(t,n):t=Iu(t,n))}),t.join(", ").replace(Ou," ")}function La(e){if(!e)return;const t=e.parentElement;t&&t.removeChild(e)}function Ir(e,t){return(t??document.head).querySelector(`style[cssr-id="${e}"]`)}function _u(e){const t=document.createElement("style");return t.setAttribute("cssr-id",e),t}function nr(e){return e?/^\s*@(s|m)/.test(e):!1}const Eu=/[A-Z]/g;function Ws(e){return e.replace(Eu,t=>"-"+t.toLowerCase())}function Au(e,t="  "){return typeof e=="object"&&e!==null?` {
